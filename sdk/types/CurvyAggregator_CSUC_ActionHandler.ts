...
export declare namespace CSUC_Types {
  ...
  export type CSAInfoStructOutput = [
    owner: string,
    token: string,
    balance: bigint,
    nonce: bigint
  ] & { owner: string; token: string; balance: bigint; nonce: bigint };
...
export interface CurvyAggregator_CSUC_ActionHandlerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "UPGRADE_INTERFACE_VERSION"
      | "_hashActionPayload"
      | "_hashActionPayloadWithCustomNonce"
      | "actionBecomesActiveAt"
      | "actionInfo"
      | "actionIsActive"
      | "aggregator"
      | "balanceAndNonce"
  ...
  encodeFunctionData(
    functionFragment: "actionBecomesActiveAt",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "actionIsActive",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getActionHandlingInfo",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace ConfigUpdatedEvent {
  export type InputTuple = [update: CSUC_Types.ConfigUpdateStruct];
  export type OutputTuple = [update: CSUC_Types.ConfigUpdateStructOutput];
  export interface OutputObject {
    update: CSUC_Types.ConfigUpdateStructOutput;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
  export type Filter = TypedDeferredTopicFilter<Event>;
  export type Log = TypedEventLog<Event>;
...
export interface CurvyAggregator_CSUC_ActionHandler extends BaseContract {
  connect(runner?: ContractRunner | null): CurvyAggregator_CSUC_ActionHandler;
  waitForDeployment(): Promise<this>;

  interface: CurvyAggregator_CSUC_ActionHandlerInterface;
  ...
  actionBecomesActiveAt: TypedContractMethod<
    [arg0: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  actionIsActive: TypedContractMethod<
  ...
  batchCSAInfo: TypedContractMethod<
    [_owners: AddressLike[], _tokens: AddressLike[]],
    [CSUC_Types.CSAInfoStructOutput[]],
    "view"
  >;

  feeCollector: TypedContractMethod<[], [string], "view">;

  getActionHandlingInfo: TypedContractMethod<
    [_actionId: BigNumberish],
    [CSUC_Types.ActionHandlingInfoStructOutput],
    "view"
  >;

  getActionId: TypedContractMethod<[], [bigint], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "actionBecomesActiveAt"
  ...
  >;
  getFunction(
    nameOrSignature: "actionIsActive"
  ): TypedContractMethod<[_actionId: BigNumberish], [boolean], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "getActionHandlingInfo"
  ): TypedContractMethod<
    [_actionId: BigNumberish],
    [CSUC_Types.ActionHandlingInfoStructOutput],
    "view"
